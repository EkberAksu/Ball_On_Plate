    ...
    virtual bool handle(const osgGA::GUIEventAdapter &ea, osgGA::GUIActionAdapter &) {
        switch (ea.getEventType()) {
            ...
            case GUIEventAdapter::SCROLL:
                break;
            case GUIEventAdapter::PEN_PRESSURE:
                break;
            case GUIEventAdapter::PEN_ORIENTATION:
                break;
            case GUIEventAdapter::PEN_PROXIMITY_ENTER:
                break;
            case GUIEventAdapter::PEN_PROXIMITY_LEAVE:
                break;
            case GUIEventAdapter::CLOSE_WINDOW:
                break;
            case GUIEventAdapter::QUIT_APPLICATION:
                break;
...
void makeMove(float x, float y) {
    KeyboardEventHandler::rotateX(-2 * x * osg::PI / 180, joint1);
    KeyboardEventHandler::rotateY(-2 * y * osg::PI / 180, joint1);
...
osg::MatrixTransform *buildJoint3() {
    ...
    osg::ShapeDrawable *shape1 = new osg::ShapeDrawable(new osg::Box(osg::Vec3(-0.5f, -9.0f, 7.0f), width, 0.5, length),
                                                        hints);
